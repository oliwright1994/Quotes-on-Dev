...
{
	wp_enqueue_style('qod-style', get_template_directory_uri() . '/build/css/style.min.css', array());
	wp_enqueue_style(
	...
	wp_enqueue_script('inhabitents-scripts', get_template_directory_uri() . '/build/js/*.min.js', array('jquery'), '20151215', true);
}
